...
const NewWorkExpFormModal: FC<WorkExperienceModalProps> = ({
  workExpId,
...
//         fetch('/api/user/workExperiences')
//           .then((res) => res.json())
//           .then((data) => setWorkExp(data.filter( (wEx: workExpI) => wEx.id === key)));
//       }
//     } ; 
//     fetchWorkExperience() }
//     , [session]); 
  ...
  return (
    <>
      <Button className="bg-transparent to-white" onClick={handleEdit}>
      ➕
      </Button>
...
export default NewWorkExpFormModal;
